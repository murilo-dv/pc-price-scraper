...
export default function page() {
  ...
  return (
    ...
    <main className='mb-20'>
      ...
      <div className='text-2xl font-bold text-black mx-14 mb-1'>Showing search results for</div>
      <div className='text-2xl font-normal text-black mx-14 mb-5'>{search}</div>
      ...
      <div className='text-center text-red-500 text-4xl mt-16 mb-16 font-bold'>
